...
function home(){return '<section class="start"><div class="ship">🦄</div><h1>Carry Quest</h1><p>Build your rainbow unicorn horn.</p><label class="endless"><input type="checkbox" data-endless '+(endless?'checked':'')+'> Unlimited trail <small>Endless levels · three lives</small></label>'+['Easy','Medium','Hard'].map((name,i)=>'<button data-mode="'+i+'"><strong>'+name+'</strong><small>Difficulty: '+(i*5)+' · +'+['1','1–2','2–3'][i]+' per level</small></button>').join('')+'<button data-open-insights>Stats</button></section>';}
